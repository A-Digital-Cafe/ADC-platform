...
export function MicroappCard({ name, description, iconColor, icon, href }: Readonly<MicroappCardProps>) {
	return (
		<a
			...
			className="group relative flex flex-col overflow-hidden rounded-3xl border border-white/10 bg-surface p-6 transition-all duration-300 hover:-translate-y-1 hover:border-white/20 hover:shadow-cozy h-70 lg:h-80 cursor-pointer no-underline! focus:outline-none active:no-underline visited:no-underline"
		>
			{/* subtle glow */}
