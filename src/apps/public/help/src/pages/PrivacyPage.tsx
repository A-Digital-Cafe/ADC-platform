...
export function PrivacyPage() {
	return (
		...
		>
			...
			<h2>3. Para qué usamos esos datos (base legal y finalidad)</h2>
			<ul>
				...
				<li>Consentimiento explícito para usos opcionales (cookies no esenciales, comunicaciones).</li>
			</ul>
			...
			<adc-callout tone="info" role="note">
				...
				sobre el sitio principal; sus proveedores, cookies o identificadores se documentarán por separado antes de activarlos.
			</adc-callout>
			...
			<p>
				...
				(logs de acceso, eventos de seguridad, datos de sesión) están en proceso de formalización; ver <a href="/roadmap">roadmap</a>.
			</p>
			...
			<p>
				...
				cobertura completa frente a OWASP ASVS y el detalle de controles forman parte del <a href="/roadmap">roadmap</a> público.
			</p>

			<h2>7. Infraestructura y subprocesadores</h2>
			...
			<p>
				...
				transferencia (ver <a href="/roadmap">roadmap</a>).
			</p>

			<h2>9. Geofiltro por país</h2>
			<p>
			...
			<p>
				...
				sufres un incidente, repórtalo por los canales de <a href="/contact">contacto</a>.
			</p>
		</PageShell>
	);
}
